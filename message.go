...
func withLevel(level, format string, args ...interface{}) ln.Fer {
	return ln.F{level: fmt.Sprintf(format, args...), "level": level}
}

// Info adds an informational connotation to this log line. This is the 
// "default" state for things that can be ignored.
func Info(format string, args ...interface{}) ln.Fer {
...
func Debug(format string, args ...interface{}) ln.Fer {
